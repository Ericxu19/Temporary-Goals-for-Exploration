...
def get_config(num_goal_objects=1, num_barriers=0, num_distractors=0, agent_has_goal=False, scale=0.1, gen = "default"):
  ...
  agent_sprite_gen = sprite_generators.generate_static_agent_sprites(agent_factors)
  ...
  config = {
    ...
    'action_space': action_spaces.Navigate(step_size=0.08),
...
def make_sprite_placement_env(config=None, seed=None):
  if config is None:
    config = get_config(num_goal_objects=2 , num_barriers=0, num_distractors=0, agent_has_goal=False, scale=0.1)
